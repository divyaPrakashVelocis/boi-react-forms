...
const API_URL = "http://192.168.10.71:8080/o/inward/";
...
export const fetchZones = () =>
    handleApi(() => axios.get(`${API_URL_COMMON}hindiZone`, { headers }));

export const fetchBranchCodes = (zoneInHindi) =>
    handleApi(() =>
        axios.post(
            `${API_URL_COMMON}branchCode`,
            {
                zoneInHindi,
            },
            { headers }
...
export const fetchFormFields = () =>
    handleApi(() => axios.get(`${API_URL_COMMON}formId/1772454`, { headers }));

export const getLoggedInUserZone = () =>
    handleApi(() =>
        axios.get(`${API_URL_COMMON}getZoneLoginUser`, { headers })
    );
...
export const getNameByAdid = (searchAdid) =>
    handleApi(() =>
        axios.post(
            `${API_URL}getFullNameByScreenName`,
            {
                searchAdid,
            },
            { headers }
