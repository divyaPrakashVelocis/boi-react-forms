...
function TableComponent() {
    ...
    const deriveRightsFromRoles = (roles) => {
        ...
        const isFormAdmin = hasRole(roles, "FORM_ADMIN_HINDI_ZONE_P1_UPDATE");
        const isZoneAdmin = hasRole(roles, "ZONE_ADMIN_HINDI_ZONE_P1_UPDATE");
        return {
            canAdd: isZoneAdmin && !isHoAdmin && !isFormAdmin,
            canEdit: isHoAdmin || isFormAdmin || isZoneAdmin,
            canDelete: isHoAdmin || isFormAdmin,
            canView: isHoAdmin || isFormAdmin || isZoneAdmin,
            canExport: isHoAdmin || isFormAdmin || isZoneAdmin,
        };
    };
