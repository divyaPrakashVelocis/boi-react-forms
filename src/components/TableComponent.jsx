...
function TableComponent() {
    ...
    const deriveRightsFromRoles = (roles) => {
        ...
        const isFormAdmin = hasRole(roles, "FORM_ADMIN_HINDI_ZONE_P2_UPDATE");
        const isZoneAdmin = hasRole(roles, "ZONE_ADMIN_HINDI_ZONE_P2_UPDATE");
        const hasAllRights = isHoAdmin || isFormAdmin || isZoneAdmin;
        return {
            canAdd: !isHoAdmin && !isFormAdmin && isZoneAdmin,
