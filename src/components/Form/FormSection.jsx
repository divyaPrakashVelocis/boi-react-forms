        ...
        <>
            <div className="container-fluid mt-4">
                ...
                <div className="row mb-3">
                    ...
                    <div className="col-md-3 mt-4 hindi-branch-new">
                ...
                <div className="form-group mb-3 hindi-branch-new">
                ...
                <div className="row">
                    <label className="col-md-5 hindi-branch-new mt-3">
                ...
                <div className="form-group my-3 hindi-branch-new">
                    <label>
                ...
                <div className="row hindi-branch-new">
                ...
                <div className="row">
                    <label className="col-md-4 hindi-branch-new">
                        ‘क’क्षेत्र
                    </label>
                ...
                <div className="row">
                    <label className="col-md-4 4mt-3 hindi-branch-new">
                ...
                <label className="hindi-branch-new">
                ...
                <div className="form-group  container-fluid hindi-branch-new">
                ...
                <div className="row ">
                    ...
                    <label className="col-md-4 mt-3 hindi-branch-new">
                        पदनाम
                    </label>
                    <div className="col-md-4">
