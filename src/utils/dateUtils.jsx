...
export const getFormName = () => {
    ...
    const formN =
        monthName === "मार्च"
            ? `हिंदी क्यूपीआर अंचल ${monthName} भाग - 1`
            : `हिंदी क्यूपीआर अंचल ${monthName}`;
...
export const initialForm = {
    ...
    officerPhone: "",
    officerEmail: "",
    totalMeetingsCmdLevel: "",
    meetingsInHindi: "",
    totalDocumentsIssuedCmd: "",
    documentsInHindi: "",
    totalDocumentsIssued: "",
    documentsIssuedBilingual: "",
    documentsIssuedEnglishOnly: "",
    documentsIssuedHindiOnly: "",
    totalLettersReceivedHindi: "",
    noReplyRequiredHindiLetters: "",
    repliedInHindiBilingual: "",
    repliedInEnglish: "",
    regionA_LettersReceivedEnglish: "",
    regionA_RepliedInHindi: "",
    regionA_RepliedInEnglish: "",
    regionA_NoReplyRequired: "",
    regionB_LettersReceivedEnglish: "",
    regionB_RepliedInHindi: "",
    regionB_RepliedInEnglish: "",
    regionB_NoReplyRequired: "",
    regionA_LettersSentHindi: "",
    regionA_LettersSentEnglish: "",
    regionA_TotalLettersSent: "",
    regionA_PercentageSentInHindi: "",
    regionB_LettersSentHindi: "",
    regionB_LettersSentEnglish: "",
    regionB_TotalLettersSent: "",
    regionB_PercentageSentInHindi: "",
    regionC_LettersSentHindi: "",
    regionC_LettersSentEnglish: "",
    regionC_TotalLettersSent: "",
    regionC_PercentageSentInHindi: "",
    pagesNotedInHindi: "",
    pagesNotedInEnglish: "",
    totalNotingPages: "",
    eOfficeHindiNotesSent: "",
    workshopsConducted: "",
    officersTrained: "",
    staffTrained: "",
    committeeMeetingDate: "",
    subordinateCommitteesCount: "",
    subordinateMeetingsThisQuarter: "",
    agendaMinutesInHindi: "",
    mobileInternetBankingInHindi: "",
    passbookEntriesInHindi: "",
    loanRecoveryLettersInHindi: "",
    formsAreBilingual: "",
    notableActivitiesSummary: "",
    committeeChairpersonName: "",
...
export const allRoles = [
    "HOADMIN",
    "FORM_ADMIN_HINDI_ZONE_P1_UPDATE",
    "ZONE_ADMIN_HINDI_ZONE_P1_UPDATE",
    "USERROLE",
];
